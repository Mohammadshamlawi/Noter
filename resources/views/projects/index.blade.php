<center>
    <li style="display: block; width: 100%;">
        <button
            style="margin-top: 15px; padding: 10px; border-radius: 10px; width: calc(100% - 30px); height: fit-content; box-shadow: 0 1px 6px 0 rgba(32, 33, 36, .28); background-color: white; border-color: transparent;">
